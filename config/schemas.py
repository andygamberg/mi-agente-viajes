...
RESERVATION_SCHEMAS = {
    'vuelo': {
        ...
        'campos': [
            ...
            {'key': 'numero_vuelo', 'label': 'Número de vuelo', 'type': 'text', 'card': True, 'placeholder': 'Ej: AR1234'},
            {'key': 'origen', 'label': 'Origen (código IATA)', 'type': 'text', 'card': True, 'required': True, 'placeholder': 'Ej: EZE'},
            {'key': 'destino', 'label': 'Destino (código IATA)', 'type': 'text', 'card': True, 'required': True, 'placeholder': 'Ej: BCN'},
            ...
            {'key': 'codigo_reserva', 'label': 'Código reserva', 'type': 'text', 'card': True, 'placeholder': 'Ej: ABC123'},
            {'key': 'pasajeros', 'label': 'Pasajeros', 'type': 'list', 'item_fields': ['nombre', 'asiento'], 'show_empty': True},
            {'key': 'terminal', 'label': 'Terminal', 'type': 'text', 'placeholder': 'Ej: A'},
            {'key': 'puerta', 'label': 'Puerta de embarque', 'type': 'text', 'placeholder': 'Ej: B12'},
